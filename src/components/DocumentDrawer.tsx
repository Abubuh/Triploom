        ...
        <div className="px-6 py-4 border-b border-border-base dark:border-[#4a6b57] shrink-0 space-y-3">
            ...
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-2 py-2 rounded-lg text-sm font-medium transition ${
                tab === "file"
                  ...
                  : "bg-surface-subtle text-text-muted hover:border-brand-mid border border-border-base"
              }`}
            >
          ...
          {tab === "file" && (
            <div
              ...
              className="border-2 border-dashed border-border-base hover:border-brand-mid rounded-xl p-6 text-center cursor-pointer transition"
            >
              <p className="text-text-muted text-sm">
                {uploading ? "⏳ Subiendo..." : "Click para seleccionar un PDF"}
              </p>
              <p className="text-text-faint text-xs mt-1">PDF hasta 10MB</p>
              <input
                ref={fileInputRef}
                type="file"
                accept=".pdf"
              ...
              return (
                ...
                >
                  ...
                  <a
                    ...
                    className="text-brand-mid hover:text-brand-dark dark:hover:text-brand-light text-xs shrink-0 transition"
                  >
